...
const UserLogin = () => {
  ...
  const handleOAuthLogin = (provider: "google" | "github") => {
    // Redirect the browser to the Spring Boot OAuth2 authorization endpoint.
    // Spring Security handles the full OAuth2 flow (redirect to provider → callback → success handler)
    // and then redirects back to the frontend /oauth/callback with the JWT.
